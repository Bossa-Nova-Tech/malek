<template>
  <b-modal id="criar-cliente" ref="costumerModal" size="lg" scrollable hide-footer hide-header class="vh-100">
    <div class="mx-4">
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-input v-if="formData.type == 'pj'" v-model="formData.cnpj" v-mask="['##.###.###/####-##']" name="cnpj"
      ...
      <b-row>
        <b-col cols="12">
          <b-form-group v-if="formData.type == 'f'" class="mb-4">
            ...
            <b-form-input v-model="formData.rg" name="rg" placeholder="00.000.000"
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-input v-model="formData.cep" name="cep" placeholder="000-0000" :class="{
