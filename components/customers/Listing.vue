          ...
          <b-row class="d-flex justify-content-center align-items-center">
            <b-col cols="9" role="button" @click="showVer(customer)">
              ...
              <div class="d-flex gray-40 my-2">
                <b-img
                  src="~/assets/img/icones/map-pin.svg"
                  alt="icone de pino do mapa, indica localização"
                />
                <h2 class="ml-2">
              ...
              <div class="d-flex gray-40">
                <b-img
                  src="~/assets/img/icones/phone.svg"
                  alt="icone de telefone, indica número do telefone"
                />
