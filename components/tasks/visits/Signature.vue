<template>
  <div class="pt-2">
    <b-row>
      <b-col cols="12">
        <vueSignature ref="signature" :sig-option="option" :w="'100%'" :h="'100px'" :disabled="disabled"
          class="border rounded mb-2"></vueSignature>
      </b-col>
    </b-row>
    <b-button-group size="sm" class="controllers d-flex">
      ...
      <b-button variant="warning" class="text-white" @click="undo">Desfazer</b-button>
