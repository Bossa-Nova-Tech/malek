<template>
  <b-modal id="criar-usuario" ref="userModal" size="lg" scrollable hide-footer hide-header centered class="vh-100">
    <div class="mx-4">
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-radio-group v-model="formData.type" :options="types" name="pessoa" plain size="sm" class="mb-2">
        </b-form-radio-group>
        <b-form-input v-if="formData.type === 'pj'" v-model="formData.cnpj" v-mask="['##.###.###/####-##']"
      ...
      <b-form-group class="mb-4">
        <label v-if="formData.type === 'f'" for="name">Nome <span class="requerido">*</span></label>
        <label v-else for="name">Nome Fantasia <span class="requerido">*</span></label>
      ...
      <b-form-group v-if="formData.type === 'f'" class="mb-4">
        ...
        <b-form-input name="last_name" v-model="formData.last_name" placeholder="Silva" :class="{
          'is-invalid': $v.formData.name.$error,
        }" />
        <b-form-invalid-feedback>
          Preencha o campo acima
      ...
      <b-row>
        <b-col cols="12">
          <b-form-group v-if="formData.type === 'f'" class="mb-4">
            ...
            <b-form-input v-model="formData.rg" name="rg" type="number" placeholder="00.000.000"
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-select v-model="formData.role" :options="options" name="role" :class="{
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-input v-model="formData.cep" name="cep" placeholder="00000000" :class="{
      ...
      <b-row>
        <b-col md="6" sm="12">
          <b-form-group class="mb-4">
            ...
            <b-form-input v-model.number="formData.number" name="number" type="number" placeholder="000" :class="{
      ...
      <b-form-group class="mb-4">
        ...
        <b-form-input v-model="formData.password" type="password" name="password" placeholder="Senha" :class="{
      ...
      <b-row class="mt-2">
        <b-col sm="12">
          ...
          <b-form-textarea v-model="formData.note" placeholder="Opcional"></b-form-textarea>
        </b-col>
      </b-row>
