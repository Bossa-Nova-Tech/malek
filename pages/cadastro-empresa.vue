  ...
  <b-container>
    <main class="row justify-content-center align-items-center min-vh-100">
      <b-form class="col col-lg-6">
        ...
        <b-form-group v-if="formData.type == 'pj'" class="mb-4">
          <label for="fantasy_name">Nome Fantasia <span class="requerido">*</span></label>
        ...
        <b-row>
          <b-col cols="12">
            <b-form-group class="mb-4">
              <label for="occupation">Qual seu cargo atual na empresa?
                <span class="requerido">*</span></label>
              <b-form-select v-model="formData.occupation" name="occupation" :options="occupations"
                :class="{ 'is-invalid': $v.formData.occupation.$error }"></b-form-select>
              <b-form-invalid-feedback>
        ...
        <b-form-group class="mb-4">
          <label for="term">Aceite de termos <span class="requerido">*</span></label>
          <b-row class="mt-n1">
            <b-col cols="12">
